...
### update user credentials (Windows User)

Updates your Windows User inside the container. Currently there is no option to update any other user than the one running the script.
